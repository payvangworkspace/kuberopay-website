    ...
    >
      ...
      {[
        ...
        <g key={i} transform={`translate(${x} ${y})`}>
          <circle cx="0" cy="0" r="10" fill="#e7e9ee" />
          <rect x="-9" y="10" width="18" height="26" rx="7" fill={c} />
          <rect x="-8" y="36" width="7" height="18" rx="3" fill="#0a1628" />
          <rect x="1" y="36" width="7" height="18" rx="3" fill="#0a1628" />
        </g>
      ))}

      {/* device / tablet accent */}
      <rect x="470" y="230" width="42" height="60" rx="6" fill="#12233f" stroke="#4ecdc4" strokeWidth="2" />
      <line x1="480" y1="270" x2="502" y2="270" stroke="#4ecdc4" strokeWidth="2" strokeLinecap="round" />

      {/* speech bubble */}
      <g transform="translate(340 150)">
        <rect x="0" y="0" width="34" height="24" rx="6" fill="#0f8f86" />
        <path d="M6 24l0 10 8-10z" fill="#0f8f86" />
      </g>
    </svg>
  );
}
    ...
    <div className="font-sans bg-[#0a1628] min-h-screen">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-8 sm:px-12 pt-20 pb-24">
          ...
          <div className="mt-14 max-w-2xl mx-auto rounded-3xl bg-white/[0.03] border border-white/5 p-6 sm:p-10 shadow-2xl shadow-black/30">
            <TeamIllustration />
          </div>

          <p className="mt-12 text-center text-lg text-white/70 leading-relaxed max-w-3xl mx-auto">
            <span className="font-semibold text-white">Kubero Pays</span> is
          ...
          <div className="mt-16 grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {cards.map((c) => (
              <div
                key={c.title}
                className="rounded-2xl bg-white/[0.03] border border-white/5 p-8 text-center hover:bg-white/[0.05] hover:-translate-y-1 transition-all duration-200"
              >
                <div className="inline-flex text-[#4ecdc4]">{c.icon}</div>
