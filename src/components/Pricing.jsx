...
export default function Pricing() {
  return (
    <div className="font-sans bg-[#0a1628] min-h-screen flex flex-col">
      <Navbar />

      {/* ============ HERO ============ */}
      <section className="relative flex-1 overflow-hidden">
        {/* soft ambient glow, consistent with the dark sections elsewhere on the site */}
        <div
          className="pointer-events-none absolute inset-0"
          style={{
            background:
              "radial-gradient(60% 50% at 50% 30%, rgba(78,205,196,0.10) 0%, transparent 70%)",
          }}
        />
        <div
        ...
        <div className="relative max-w-4xl mx-auto px-8 sm:px-12 pt-28 pb-24 text-center">
          <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl leading-tight text-white">
            ...
            <span className="bg-gradient-to-r from-[#4ecdc4] to-[#3d9bdb] bg-clip-text text-transparent">
              for India
            </span>{" "}
            <span className="align-middle">🇮🇳</span>
          </h1>

          <p className="mt-7 text-lg text-white/60 max-w-2xl mx-auto leading-relaxed">
          ...
          {/* contact card */}
          <div className="mt-14 max-w-xl mx-auto rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-sm px-10 py-12 shadow-2xl shadow-black/30">
            <p className="text-white/85 text-lg">
              For detailed pricing, please contact our Sales team.
            </p>

            <button
              className="mt-8 w-full py-4 rounded-xl text-[#0a1628] font-bold text-base
          ...
          <p className="mt-10 text-xs text-white/35 max-w-xl mx-auto leading-relaxed">
